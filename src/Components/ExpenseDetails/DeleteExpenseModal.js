...
const DeleteExpenseModal = ({ isOpen, onClose, onConfirm, expenseTitle }) => {
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-700">
              <div className="flex items-center">
                ...
                <h2 className="text-xl font-semibold text-white">Delete Expense</h2>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="p-6">
              <div className="mb-6">
                <p className="text-gray-300 mb-4">
                  ...
                  <span className="font-semibold text-white">"{expenseTitle}"</span>?
                </p>
                
                <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 mb-6">
                  <h3 className="text-red-400 font-medium mb-2">⚠️ This action cannot be undone</h3>
                  <ul className="text-sm text-gray-300 space-y-1">
                    <li>• The expense will be permanently deleted</li>
                    <li>• All associated data will be lost</li>
                    <li>• Group balances will be recalculated</li>
                    <li>• Receipt and audit trail will be removed</li>
                  </ul>
                </div>
